...
export const sendModelList = async (fastify, userIdx, reply) => {
  await fastify.pg.query("SELECT idx, user_idx, model_name FROM ml_model WHERE user_idx=$1", [userIdx], async (err, result) => {
