import { mlProjectOwnerModel, mlProjectsModel } from "../models/projStructure.model.js";
...
const getProjList = {
  ...
  handler: function (req, rep) {
    this.pg.query("SELECT idx, user_idx, proj_name FROM ml_project WHERE user_idx=$1", [Number(req.params.user_idx)], function onResult(err, result) {
